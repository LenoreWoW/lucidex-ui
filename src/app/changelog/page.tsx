...
export const metadata: Metadata = {
  ...
  description: 'Track changes, updates, and improvements to the Lucidex UI design system.',
};
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <span
                className={`px-3 py-1 rounded-full text-sm font-medium ${
                  entry.type === 'major'
                    ? 'bg-qgba-al-adaam/10 text-qgba-al-adaam border border-qgba-al-adaam/20'
                    : entry.type === 'minor'
                    ? 'bg-qgba-sea/10 text-qgba-sea border border-qgba-sea/20'
                    : 'bg-qgba-palm/10 text-qgba-palm border border-qgba-palm/20'
                }`}
              >
                {entry.type}
              </span>
      ...
      <div className="mt-12 p-6 bg-card border rounded-lg">
        ...
        <p className="text-muted-foreground mb-4">
          Want to be notified about new releases and updates? Follow our development progress and get the latest news.
        </p>
